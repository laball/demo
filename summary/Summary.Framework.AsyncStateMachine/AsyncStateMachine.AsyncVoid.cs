...
{
    // <Test>d__0 -> AsyncVoidStateMachine
    ...
    public class AsyncVoid
    {
        ...
        {
            // Fields
            public static readonly AsyncVoid.class_c c = new AsyncVoid.class_c();//.<>c<>9 = new AsyncVoid.<>c();
            ...
            public void MoveNext()
            {
                ...
                try
                {
                    ...
                    if (num != 0)
                    {
                        ...
                        awaiter = System.Threading.Tasks.Task.Factory.StartNew(AsyncVoid.class_c.action ?? (AsyncVoid.class_c.action = new Action(AsyncVoid.class_c.c.fun))).GetAwaiter();
                        //******************************************************************************************************************************************************************
